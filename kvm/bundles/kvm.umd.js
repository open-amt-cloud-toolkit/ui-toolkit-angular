(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@open-amt-cloud-toolkit/ui-toolkit/core'), require('rxjs'), require('rxjs/operators'), require('@angular/platform-browser'), require('@angular/platform-browser/animations'), require('@angular/common/http')) :
    typeof define === 'function' && define.amd ? define('kvm', ['exports', '@angular/core', '@open-amt-cloud-toolkit/ui-toolkit/core', 'rxjs', 'rxjs/operators', '@angular/platform-browser', '@angular/platform-browser/animations', '@angular/common/http'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.kvm = {}, global.ng.core, global['@open-amt-cloud-toolkit']['ui-toolkit'].core, global.rxjs, global.rxjs.operators, global.ng.platformBrowser, global.ng.platformBrowser.animations, global.ng.common.http));
}(this, (function (exports, i0, core, rxjs, operators, platformBrowser, animations, http) { 'use strict';
    ...
    var KvmComponent = /** @class */ (function () {
        function KvmComponent() {
            ...
            this.urlConstructor = function () {
                return _this.mpsServer.replace('http', 'ws');
            };
        ...
        KvmComponent.prototype.instantiate = function () {
            ...
            this.redirector = new core.AMTKvmDataRedirector(this.logger, core.Protocol.KVM, new FileReader(), this.deviceId, 16994, '', '', 0, 0, this.authToken, this.server);
    ...
    KvmModule.ɵinj = i0.ɵɵdefineInjector({ imports: [[http.HttpClientModule, platformBrowser.BrowserModule, animations.BrowserAnimationsModule]] });
    (function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(KvmModule, { declarations: [KvmComponent], imports: [http.HttpClientModule, platformBrowser.BrowserModule, animations.BrowserAnimationsModule], exports: [KvmComponent] }); })();
    (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(KvmModule, [{
                type: i0.NgModule,
                args: [{
                        declarations: [KvmComponent],
                        imports: [http.HttpClientModule, platformBrowser.BrowserModule, animations.BrowserAnimationsModule],
